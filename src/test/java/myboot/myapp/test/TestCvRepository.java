...
public class TestCvRepository {
	...
	public void createAndRead() {
		...
		var u = userRepo.save(new User("yac@gmail.com","Boukhari","Yacine","mon site", "18/01/1998", "mdp"));
		...
		assertEquals(userRepo.findById(u.getEmail()).get().getCv().getId(), u2.get().getId());
	}
